...
# R Markdown Basics --> Introduction {#rmd-basics}
<!--
Would treat each first-level header as a separate chapter
-->
<!--
can change "#rmd-basics" to "intro" to replace the "Chapter X"

don't know why this is helpful
-->
